...
_AUDIT_REPOSITORY_REVIEWED_COLLABORATOR_EDGES = {
    ...
    "src/zeroth/runtime/orchestration/parallel_executor.py": {
        ...
        (
            ("RuntimeParallelExecutor", "execute_fan_out_resume"),
            ("self", "audit_recorder", "audit_repository"),
        ): frozenset({"write"}),
    },
...
_AUDIT_REPOSITORY_PUBLIC_CALL_INVENTORY = (
    ...
    "release/live_evaluation/ambiguous_operation_demo.py::seed_ambiguous_operation_demo::get",
    "release/live_evaluation/ambiguous_operation_demo.py::seed_ambiguous_operation_demo::write",
    "release/live_evaluation/economics_ui_fixture.py::seed_economics_records::get",
    "release/live_evaluation/economics_ui_fixture.py::seed_economics_records::get",
    "release/live_evaluation/economics_ui_fixture.py::seed_economics_records::write",
    "release/live_evaluation/economics_ui_fixture.py::seed_economics_records::write",
    ...
    "src/zeroth/service/api/audit_api.py::_composed_audits::list_by_run",
    ...
    "src/zeroth/service/api/rightsizing_api.py::_composed_deployment_records::list",
    "src/zeroth/service/api/rightsizing_api.py::_write_rightsizing_call_audits::write",
    "src/zeroth/service/api/run_api.py::_record_guardrail_rejection::write",
