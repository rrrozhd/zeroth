...
ALLOWED_DIRECT_CONSTRUCTION: frozenset[str] = frozenset(
    {
        ...
        "econ/instrumentation/transport.py::TelemetryTransport._flush_asgi._run::httpx.AsyncClient",
        "econ/instrumentation/transport.py::TelemetryTransport._flush_http::httpx.Client",
