...
following signatures and seven D01 amendment receipts, each binding the exact old
...
fixture and guide changes are committed separately from production changes.
...
| `zeroth.core.service.guardrail_api:GuardrailPolicyResponse` | `zeroth.service.api.guardrail_api:GuardrailPolicyResponse` | Add the ingress guardrail management response | Protected capability ID | Canonical class | Not removed |
...
| `zeroth.core.execution_units:AdmissionController` | `zeroth.integrations.execution:AdmissionController` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:AdmissionResult` | `zeroth.integrations.execution:AdmissionResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ArtifactSource` | `zeroth.integrations.execution:ArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:AuditSettings` | `zeroth.integrations.execution:AuditSettings` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:BuildConfig` | `zeroth.integrations.execution:BuildConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:CommandArtifactSource` | `zeroth.integrations.execution:CommandArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:CommandRuntimeAdapter` | `zeroth.integrations.execution:CommandRuntimeAdapter` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:DependencySpec` | `zeroth.integrations.execution:DependencySpec` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:DockerSandboxConfig` | `zeroth.integrations.execution:DockerSandboxConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:EntryPointType` | `zeroth.integrations.execution:EntryPointType` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:EnvironmentCacheManager` | `zeroth.integrations.execution:EnvironmentCacheManager` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:EnvironmentVariable` | `zeroth.integrations.execution:EnvironmentVariable` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitAdmissionError` | `zeroth.integrations.execution:ExecutableUnitAdmissionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitBinding` | `zeroth.integrations.execution:ExecutableUnitBinding` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitError` | `zeroth.integrations.execution:ExecutableUnitError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitExecutionError` | `zeroth.integrations.execution:ExecutableUnitExecutionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitManifest` | `zeroth.integrations.execution:ExecutableUnitManifest` | Move execution integrations | Legacy path still re-exports | Same object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitNotFoundError` | `zeroth.integrations.execution:ExecutableUnitNotFoundError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitRegistry` | `zeroth.integrations.execution:ExecutableUnitRegistry` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitRunResult` | `zeroth.integrations.execution:ExecutableUnitRunResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitRunner` | `zeroth.integrations.execution:ExecutableUnitRunner` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutableUnitValidator` | `zeroth.integrations.execution:ExecutableUnitValidator` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutionIOError` | `zeroth.integrations.execution:ExecutionIOError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExecutionMode` | `zeroth.integrations.execution:ExecutionMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ExtractedOutput` | `zeroth.integrations.execution:ExtractedOutput` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:FreeformPayload` | `zeroth.integrations.execution:FreeformPayload` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:InjectedInput` | `zeroth.integrations.execution:InjectedInput` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:InlineSourceArtifactSource` | `zeroth.integrations.execution:InlineSourceArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:InlineUnitManifest` | `zeroth.integrations.execution:InlineUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:InputInjectionError` | `zeroth.integrations.execution:InputInjectionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:InputMode` | `zeroth.integrations.execution:InputMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ManifestIntegrityRecord` | `zeroth.integrations.execution:ManifestIntegrityRecord` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ManifestValidationError` | `zeroth.integrations.execution:ManifestValidationError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:NativeUnitManifest` | `zeroth.integrations.execution:NativeUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:OutputConversionError` | `zeroth.integrations.execution:OutputConversionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:OutputExtractionError` | `zeroth.integrations.execution:OutputExtractionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:OutputMode` | `zeroth.integrations.execution:OutputMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ProjectArchiveArtifactSource` | `zeroth.integrations.execution:ProjectArchiveArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ProjectUnitManifest` | `zeroth.integrations.execution:ProjectUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:PythonModuleArtifactSource` | `zeroth.integrations.execution:PythonModuleArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:PythonRuntimeAdapter` | `zeroth.integrations.execution:PythonRuntimeAdapter` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ResourceConstraints` | `zeroth.integrations.execution:ResourceConstraints` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ResourceLimits` | `zeroth.integrations.execution:ResourceLimits` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:RunConfig` | `zeroth.integrations.execution:RunConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:RuntimeAdapter` | `zeroth.integrations.execution:RuntimeAdapter` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:RuntimeLanguage` | `zeroth.integrations.execution:RuntimeLanguage` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxBackendMode` | `zeroth.integrations.execution:SandboxBackendMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxBackendUnavailableError` | `zeroth.integrations.execution:SandboxBackendUnavailableError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxConfig` | `zeroth.integrations.execution:SandboxConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxEnvironment` | `zeroth.integrations.execution:SandboxEnvironment` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxExecutionResult` | `zeroth.integrations.execution:SandboxExecutionResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxManager` | `zeroth.integrations.execution:SandboxManager` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxPolicyViolationError` | `zeroth.integrations.execution:SandboxPolicyViolationError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxStrictnessMode` | `zeroth.integrations.execution:SandboxStrictnessMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:SandboxTimeoutError` | `zeroth.integrations.execution:SandboxTimeoutError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:ValidationCode` | `zeroth.integrations.execution:ValidationCode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:WrappedCommandUnitManifest` | `zeroth.integrations.execution:WrappedCommandUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units:build_docker_resource_flags` | `zeroth.integrations.execution:build_docker_resource_flags` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:build_inline_binding` | `zeroth.integrations.execution:build_inline_binding` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:build_inline_manifest` | `zeroth.integrations.execution:build_inline_manifest` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:build_sandbox_environment` | `zeroth.integrations.execution:build_sandbox_environment` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:compute_environment_cache_key` | `zeroth.integrations.execution:compute_environment_cache_key` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:compute_manifest_digest` | `zeroth.integrations.execution:compute_manifest_digest` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:convert_output` | `zeroth.integrations.execution:convert_output` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:docker_container_running` | `zeroth.integrations.execution:docker_container_running` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:extract_output` | `zeroth.integrations.execution:extract_output` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:inject_input` | `zeroth.integrations.execution:inject_input` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units:inline_source_digest` | `zeroth.integrations.execution:inline_source_digest` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.constraints:ResourceConstraints` | `zeroth.integrations.execution.constraints:ResourceConstraints` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.constraints:build_docker_resource_flags` | `zeroth.integrations.execution.constraints:build_docker_resource_flags` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.errors:ManifestValidationError` | `zeroth.integrations.execution.errors:ManifestValidationError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.errors:UnsupportedRuntimeAdapterError` | `zeroth.integrations.execution.errors:UnsupportedRuntimeAdapterError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.inline:INLINE_SOURCE_MAX_CHARS` | `zeroth.integrations.execution.inline:INLINE_SOURCE_MAX_CHARS` | Move execution integrations | Legacy path still re-exports | Same object | Not removed |
| `zeroth.core.execution_units.inline:build_inline_binding` | `zeroth.integrations.execution.inline:build_inline_binding` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.integrity:AdmissionController` | `zeroth.integrations.execution.integrity:AdmissionController` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.integrity:AdmissionResult` | `zeroth.integrations.execution.integrity:AdmissionResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.integrity:ManifestIntegrityRecord` | `zeroth.integrations.execution.integrity:ManifestIntegrityRecord` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.integrity:compute_manifest_digest` | `zeroth.integrations.execution.integrity:compute_manifest_digest` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.io:ExecutionIOError` | `zeroth.integrations.execution.io:ExecutionIOError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.io:InputInjectionError` | `zeroth.integrations.execution.io:InputInjectionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.io:OutputConversionError` | `zeroth.integrations.execution.io:OutputConversionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.io:OutputExtractionError` | `zeroth.integrations.execution.io:OutputExtractionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ArtifactSource` | `zeroth.integrations.execution.models:ArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:AuditSettings` | `zeroth.integrations.execution.models:AuditSettings` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:BuildConfig` | `zeroth.integrations.execution.models:BuildConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:CommandArtifactSource` | `zeroth.integrations.execution.models:CommandArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:DependencySpec` | `zeroth.integrations.execution.models:DependencySpec` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:EnvironmentVariable` | `zeroth.integrations.execution.models:EnvironmentVariable` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ExecutableUnitManifestBase` | `zeroth.integrations.execution.models:ExecutableUnitManifestBase` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ExecutionMode` | `zeroth.integrations.execution.models:ExecutionMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:InlineSourceArtifactSource` | `zeroth.integrations.execution.models:InlineSourceArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:InlineUnitManifest` | `zeroth.integrations.execution.models:InlineUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:InputMode` | `zeroth.integrations.execution.models:InputMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:NativeUnitManifest` | `zeroth.integrations.execution.models:NativeUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:OutputMode` | `zeroth.integrations.execution.models:OutputMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ProjectArchiveArtifactSource` | `zeroth.integrations.execution.models:ProjectArchiveArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ProjectUnitManifest` | `zeroth.integrations.execution.models:ProjectUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:PythonModuleArtifactSource` | `zeroth.integrations.execution.models:PythonModuleArtifactSource` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:ResourceLimits` | `zeroth.integrations.execution.models:ResourceLimits` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:RunConfig` | `zeroth.integrations.execution.models:RunConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.models:WrappedCommandUnitManifest` | `zeroth.integrations.execution.models:WrappedCommandUnitManifest` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitAdmissionError` | `zeroth.integrations.execution.runner:ExecutableUnitAdmissionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitBinding` | `zeroth.integrations.execution.runner:ExecutableUnitBinding` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitError` | `zeroth.integrations.execution.runner:ExecutableUnitError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitExecutionError` | `zeroth.integrations.execution.runner:ExecutableUnitExecutionError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitInputError` | `zeroth.integrations.execution.runner:ExecutableUnitInputError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitNotFoundError` | `zeroth.integrations.execution.runner:ExecutableUnitNotFoundError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitRegistry` | `zeroth.integrations.execution.runner:ExecutableUnitRegistry` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitRunResult` | `zeroth.integrations.execution.runner:ExecutableUnitRunResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.runner:ExecutableUnitRunner` | `zeroth.integrations.execution.runner:ExecutableUnitRunner` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:DockerSandboxConfig` | `zeroth.integrations.execution.sandbox:DockerSandboxConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:EnvironmentCacheManager` | `zeroth.integrations.execution.sandbox:EnvironmentCacheManager` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxBackendMode` | `zeroth.integrations.execution.sandbox:SandboxBackendMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxBackendUnavailableError` | `zeroth.integrations.execution.sandbox:SandboxBackendUnavailableError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxConfig` | `zeroth.integrations.execution.sandbox:SandboxConfig` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxEnvironment` | `zeroth.integrations.execution.sandbox:SandboxEnvironment` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxExecutionResult` | `zeroth.integrations.execution.sandbox:SandboxExecutionResult` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxManager` | `zeroth.integrations.execution.sandbox:SandboxManager` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxPolicyViolationError` | `zeroth.integrations.execution.sandbox:SandboxPolicyViolationError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxStrictnessMode` | `zeroth.integrations.execution.sandbox:SandboxStrictnessMode` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:SandboxTimeoutError` | `zeroth.integrations.execution.sandbox:SandboxTimeoutError` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.execution_units.sandbox:build_sandbox_environment` | `zeroth.integrations.execution.sandbox:build_sandbox_environment` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.sandbox:compute_environment_cache_key` | `zeroth.integrations.execution.sandbox:compute_environment_cache_key` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.sandbox:docker_container_running` | `zeroth.integrations.execution.sandbox:docker_container_running` | Move execution integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.execution_units.sidecar_client:SandboxSidecarClient` | `zeroth.integrations.execution.sidecar_client:SandboxSidecarClient` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.governed.integrations.tool_calls:GovernedToolCallLoop` | `zeroth.runtime.agents.tooling.tool_calls:GovernedToolCallLoop` | Move execution integrations | Legacy path still re-exports | Same class object | Not removed |
...
| `zeroth.core.memory:ConnectorManifest` | `zeroth.integrations.memory:ConnectorManifest` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:InMemoryConnectorRegistry` | `zeroth.integrations.memory:InMemoryConnectorRegistry` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:KeyValueMemoryConnector` | `zeroth.integrations.memory:KeyValueMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:MemoryConnectorResolver` | `zeroth.integrations.memory:MemoryConnectorResolver` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:ResolvedMemoryBinding` | `zeroth.integrations.memory:ResolvedMemoryBinding` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:RunEphemeralMemoryConnector` | `zeroth.integrations.memory:RunEphemeralMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:ThreadMemoryConnector` | `zeroth.integrations.memory:ThreadMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory:register_memory_connectors` | `zeroth.integrations.memory:register_memory_connectors` | Consolidate memory integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.memory.capability_guard:CapabilityEnforcingMemoryConnector` | `zeroth.integrations.memory.capability_guard:CapabilityEnforcingMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.chroma_connector:ChromaDBMemoryConnector` | `zeroth.integrations.memory.chroma_connector:ChromaDBMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.config_repository:MemoryConnectorConfigRepository` | `zeroth.integrations.memory.config_repository:MemoryConnectorConfigRepository` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.connectors:KeyValueMemoryConnector` | `zeroth.integrations.memory.connectors:KeyValueMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.connectors:RunEphemeralMemoryConnector` | `zeroth.integrations.memory.connectors:RunEphemeralMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.connectors:ThreadMemoryConnector` | `zeroth.integrations.memory.connectors:ThreadMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.elastic_connector:ElasticsearchMemoryConnector` | `zeroth.integrations.memory.elastic_connector:ElasticsearchMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.factory:register_memory_connectors` | `zeroth.integrations.memory.factory:register_memory_connectors` | Consolidate memory integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.memory.models:ConnectorManifest` | `zeroth.integrations.memory.models:ConnectorManifest` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.models:ResolvedMemoryBinding` | `zeroth.integrations.memory.models:ResolvedMemoryBinding` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.pgvector_connector:PgvectorMemoryConnector` | `zeroth.integrations.memory.pgvector_connector:PgvectorMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.redis_kv:RedisKVMemoryConnector` | `zeroth.integrations.memory.redis_kv:RedisKVMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.redis_thread:RedisThreadMemoryConnector` | `zeroth.integrations.memory.redis_thread:RedisThreadMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.registry:InMemoryConnectorRegistry` | `zeroth.integrations.memory.registry:InMemoryConnectorRegistry` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.registry:MemoryConnectorResolver` | `zeroth.integrations.memory.registry:MemoryConnectorResolver` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.runtime_configs:apply_config` | `zeroth.integrations.memory.runtime_configs:apply_config` | Consolidate memory integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.memory.runtime_configs:load_persisted_connectors` | `zeroth.integrations.memory.runtime_configs:load_persisted_connectors` | Consolidate memory integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.memory.tenant_scoped:TenantScopeError` | `zeroth.integrations.memory.tenant_scoped:TenantScopeError` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.tenant_scoped:TenantScopedMemoryConnector` | `zeroth.integrations.memory.tenant_scoped:TenantScopedMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
| `zeroth.core.memory.tenant_scoped:tenant_slug` | `zeroth.integrations.memory.tenant_scoped:tenant_slug` | Consolidate memory integrations | Legacy path still re-exports | Same function object | Not removed |
| `zeroth.core.governed.memory.auditing:AuditingMemoryConnector` | `zeroth.integrations.memory.governed.auditing:AuditingMemoryConnector` | Consolidate memory integrations | Legacy path still re-exports | Same class object | Not removed |
