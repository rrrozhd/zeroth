...
from zeroth.runtime.orchestration.protocols import ExecutableUnitRunner, RunRepository
    ...
    async def run_graph(
        ...
        *,
        ...
        run = Run(
            ...
            current_node_ids=[],
            pending_node_ids=(
                [] if token_engine_enabled(graph.execution_settings) else [self._entry_step(graph)]
            ),
