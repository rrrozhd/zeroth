"""Legacy import path for the gateway wire models.

The wire models now live in :mod:`zeroth.contracts.langgraph_gateway.models`; this
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.contracts.langgraph_gateway.models as _canonical
