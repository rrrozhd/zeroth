"""Legacy import path for the gateway transport module.

It now lives in :mod:`zeroth.service.langgraph_gateway.transport`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.transport as _canonical
