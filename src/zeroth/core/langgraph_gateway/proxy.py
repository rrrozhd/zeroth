"""Legacy import path for the gateway proxy module.

It now lives in :mod:`zeroth.service.langgraph_gateway.proxy`; this module
...
if TYPE_CHECKING:
    from zeroth.service.langgraph_gateway.proxy import (
        GatewayEventSink,
        GatewayProxy,
    )
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.proxy as _canonical
