"""Legacy import path for the gateway compatibility module.

It now lives in :mod:`zeroth.service.langgraph_gateway.compatibility`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.compatibility as _canonical
