"""Legacy import path for the gateway enforcement_store module.

It now lives in :mod:`zeroth.service.langgraph_gateway.enforcement_store`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.enforcement_store as _canonical
