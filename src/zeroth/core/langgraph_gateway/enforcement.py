"""Legacy import path for the gateway enforcement module.

It now lives in :mod:`zeroth.service.langgraph_gateway.enforcement`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.enforcement as _canonical
