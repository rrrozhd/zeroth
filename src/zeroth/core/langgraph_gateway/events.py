"""Legacy import path for the gateway events module.

It now lives in :mod:`zeroth.governance.langgraph_gateway.events`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.governance.langgraph_gateway.events as _canonical
