"""Legacy import path for the gateway capabilities module.

It now lives in :mod:`zeroth.governance.langgraph_gateway.capabilities`; this module
...
``governance`` package onto the import path of anything that merely touches
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.governance.langgraph_gateway.capabilities as _canonical
