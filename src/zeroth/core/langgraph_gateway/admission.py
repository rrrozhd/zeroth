"""Legacy import path for the gateway admission module.

It now lives in :mod:`zeroth.service.langgraph_gateway.admission`; this module
...
def __getattr__(name: str) -> Any:
    ...
    import zeroth.service.langgraph_gateway.admission as _canonical
