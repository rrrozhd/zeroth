...
from zeroth.contracts.langgraph_gateway.inventory import classify_protocol_command
...
class WebSocketGatewayHandler:
    ...
    async def handle(self, websocket: WebSocket) -> None:  # noqa: C901
    ...
    # moved the module without changing a line of the body; reducing it here
    # would mix a behaviour-bearing refactor into a pure move.
    async def transform_client_message(  # noqa: C901
        self,
        websocket: WebSocket,
