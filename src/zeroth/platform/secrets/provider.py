...
if TYPE_CHECKING:
    ...
    # concrete import would create an import-time cycle, and the platform layer
    # must not load integration code. The annotation itself cannot be dropped:
    # SecretResolver's pinned legacy signatures name EnvironmentVariable, and
    # SecretResolver cannot move to the integrations layer because runtime code
